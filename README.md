...
- **Next.js** – struktur, routing og server-side rendering  
- **TypeScript** – typesikker utvikling  
- **TailwindCSS** – rask og modulær styling  
- **shadcn/ui** – fleksible og tilgjengelige UI-komponenter  
- **Firebase** (Firestore, Authentication, Storage) – database, innlogging og filhåndtering  
...
Prosjektet følger standard Next.js-struktur for sider, komponenter og API-kall.